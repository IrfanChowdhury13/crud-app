        ...
        <div class="container mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg max-w-3xl">
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea rows="3" class="mb-3" style="display: none" name="product_detail" id="quill-editor-area">
                    </textarea>
                </div>
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition-all duration-300">Update
                        Product</button>
                </div>
